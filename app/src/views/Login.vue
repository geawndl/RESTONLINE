<template>
  ...
  <script>
    ...
    export default {
        ...
        methods: {
            doLogin(){ 
                if(this.email === "admin@domain.net" && this.password === "admin") router.push('/dashboard')
                if(this.email === "client@domain.net" && this.password === "client") router.push('/')
                alert("Authentification failed x|")
            }
        }
    }
    </script>
