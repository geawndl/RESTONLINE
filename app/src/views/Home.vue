...
<div>
    <header>
        <h2><router-link class="link" @click = "setView('/')" to="/">RESTONLINE</router-link></h2>
        <nav>
		<li><router-link class = "link" @click = "setView('/commande')" to="/commande">Commander</router-link></li>
		<li><router-link class = "link" @click = "setView('/tracking')" to="/tracking">Suivi</router-link></li>
		<li><router-link class = "link" @click = "setView('/login')" to="/login">Connexion</router-link></li>
		<li><router-link class = "link" @click = "setView('/register')" to="/register">Inscription</router-link></li>
        </nav>
  </header>
  ...
  <section class="hero">
    ...
    <div class="hero-content-area">
      ...
      <a href="#" class="link btn" @click="setView('/Commande')">Contact Us Now</a>
    </div>
  </section>
